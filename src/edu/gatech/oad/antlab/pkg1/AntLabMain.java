 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Hailey");
		  toPrint += p1.toString("902788602");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Samuel");
		  toPrint += p2.toString("902912564");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Emily");
		  toPrint += p3.toString("902448756");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Premkumar Saravanan");
          toPrint += p4.toString("902926435");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Richard");
          toPrint += p5.toString("902813066");
